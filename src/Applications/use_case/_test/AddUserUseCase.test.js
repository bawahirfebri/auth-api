...
const UserRepository = require("../../../Domains/users/UserRespository");
...
describe('AddUserUseCase', () => {
  it('should orchestrating the add user action correctly', async () => {
    ...
    const getUserUserCase = new AddUserUseCase({
      userRepository: mockUserRepository,
      passwordHash: mockPasswordHash,
    })

    // Action
    const registeredUser = await getUserUserCase.execute(useCasePayload);
